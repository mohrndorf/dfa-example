 ...
 * </p>
 * <ul>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.StateImpl#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.StateImpl#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.StateImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.StateImpl#isIsStart <em>Is Start</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.StateImpl#isIsEnd <em>Is End</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public EList<Transition> getOutgoingTransitions() {
		if (outgoingTransitions == null) {
			outgoingTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this,
					DfamodelPackage.STATE__OUTGOING_TRANSITIONS, DfamodelPackage.TRANSITION__FROM);
		}
	...
	public EList<Transition> getIncomingTransitions() {
		if (incomingTransitions == null) {
			incomingTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this,
					DfamodelPackage.STATE__INCOMING_TRANSITIONS, DfamodelPackage.TRANSITION__TO);
		}
	...
	public void setIsStart(boolean newIsStart) {
		...
		isStart = newIsStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DfamodelPackage.STATE__IS_START, oldIsStart,
					isStart));
	}
