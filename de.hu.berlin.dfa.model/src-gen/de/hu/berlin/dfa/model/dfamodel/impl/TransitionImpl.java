 ...
 * </p>
 * <ul>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.TransitionImpl#getFrom <em>From</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.TransitionImpl#getTo <em>To</em>}</li>
 *   <li>{@link de.hu.berlin.dfa.model.dfamodel.impl.TransitionImpl#getInput <em>Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfamodelPackage.TRANSITION__FROM, oldFrom,
							from));
			}
		}
		return from;
	...
	public NotificationChain basicSetFrom(State newFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DfamodelPackage.TRANSITION__FROM, oldFrom, newFrom);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFrom(State newFrom) {
		if (newFrom != from) {
			...
			if (from != null)
				msgs = ((InternalEObject) from).eInverseRemove(this, DfamodelPackage.STATE__OUTGOING_TRANSITIONS,
						State.class, msgs);
			if (newFrom != null)
				msgs = ((InternalEObject) newFrom).eInverseAdd(this, DfamodelPackage.STATE__OUTGOING_TRANSITIONS,
						State.class, msgs);
	...
	public State getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DfamodelPackage.TRANSITION__TO, oldTo,
							to));
			}
		}
		return to;
	...
	public NotificationChain basicSetTo(State newTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DfamodelPackage.TRANSITION__TO, oldTo, newTo);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTo(State newTo) {
		if (newTo != to) {
			NotificationChain msgs = null;
			if (to != null)
				msgs = ((InternalEObject) to).eInverseRemove(this, DfamodelPackage.STATE__INCOMING_TRANSITIONS,
						State.class, msgs);
			if (newTo != null)
				msgs = ((InternalEObject) newTo).eInverseAdd(this, DfamodelPackage.STATE__INCOMING_TRANSITIONS,
						State.class, msgs);
