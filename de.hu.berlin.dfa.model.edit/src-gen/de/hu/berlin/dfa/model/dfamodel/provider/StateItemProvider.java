...
/**
 * This is the item provider adapter for a {@link de.hu.berlin.dfa.model.dfamodel.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOutgoingTransitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_outgoingTransitions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_outgoingTransitions_feature",
								"_UI_State_type"),
						DfamodelPackage.Literals.STATE__OUTGOING_TRANSITIONS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_State_incomingTransitions_feature",
								"_UI_State_type"),
						DfamodelPackage.Literals.STATE__INCOMING_TRANSITIONS, true, false, true, null, null, null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_id_feature", "_UI_State_type"),
						DfamodelPackage.Literals.STATE__ID, true, false, false,
	...
	protected void addIsStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_isStart_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_isStart_feature", "_UI_State_type"),
						DfamodelPackage.Literals.STATE__IS_START, true, false, false,
	...
	protected void addIsEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_isEnd_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_isEnd_feature", "_UI_State_type"),
						DfamodelPackage.Literals.STATE__IS_END, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
